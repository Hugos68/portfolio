<script lang="ts">
	...
	import { AppBar,drawerStore,storeLightSwitch, tooltip, type DrawerSettings} from "@skeletonlabs/skeleton";
...
<AppBar padding="px-[5vw] py-4" shadow="{yScroll<=0 ? "shadow-none" : "shadow-lg"}" background="{yScroll<=0 ? "bg-none" : "bg-surface-100-800-token"}">
	...
	<svelte:fragment slot="trail">
        ...
        <button class="btn variant-filled-primary" on:click={openHamburger}>
